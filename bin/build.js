 ...
 * replaces @@placeholders in style.css, generates minified CSS,
 * and emits version.php from composer.json.
 */
...
// Step 5: Generate version.php from composer.json.
console.log('Generating version.php...');
const versionPhp = `<?php
/**
 * Generated by \`npm run build\`. Do not edit.
 */
define( 'SOVEREIGNTY_VERSION', '${composer.version}' );
`;
fs.writeFileSync(path.join(root, 'version.php'), versionPhp);
