 ...
 * @return void
 */
function autonomie_post_kinds_init(): void { // phpcs:ignore Generic.NamingConventions.CamelCapsFunctionName.NotCamelCaps
 ...
 * @return void
 */
function autonomie_post_kinds_content(): void { // phpcs:ignore Generic.NamingConventions.CamelCapsFunctionName.NotCamelCaps
 ...
 */
function autonomie_post_kinds_format( string $post_format_html ): string { // phpcs:ignore Generic.NamingConventions.CamelCapsFunctionName.NotCamelCaps, Squiz.NamingConventions.ValidVariableName.NotCamelCaps
	if ( ! get_post_kind_slug() ) { // @phpstan-ignore function.notFound (Post Kinds plugin)
		return $post_format_html; // phpcs:ignore Squiz.NamingConventions.ValidVariableName.NotCamelCaps
	}
