...
<div id="share-options" style="display: none;">
	...
	<p>
		<label for="entry-permalink"><?php esc_html_e( 'Permalink', 'sovereignty' ); ?></label>
	...
	if ( get_the_title() !== '' ) {
		?>
	<p>
		<label for="entry-summary"><?php esc_html_e( 'HTML', 'sovereignty' ); ?></label>
	...
	<?php } else { ?>
	<p>
		<label for="entry-blockquote"><?php esc_html_e( 'HTML', 'sovereignty' ); ?></label>
